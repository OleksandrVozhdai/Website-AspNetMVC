    ...
    public partial class addedIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientsTable", x => x.IngredientID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PizzaIngredients_IngredientsTable_IngredientID",
                        column: x => x.IngredientID,
                        principalTable: "IngredientsTable",
                        principalColumn: "IngredientID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PizzaIngredients_PizzaTable_PizzaID",
                        column: x => x.PizzaID,
                        principalTable: "PizzaTable",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
